...
<main class="container mx-auto grid items-start lg:grid-cols-2">
  <section class="space-y-4 p-6">
    ...
    <p>
      ...
      cada materia dejó de actualizarse desde el 1C2024. Para solventar esto de manera automatizada
      se quiere de acceso a las ofertas de todas las carreras en cada cuatrimestre. Sin embargo, yo
      solo puedo acceder a la oferta para las materias de mi carrera, no de las materias que no
      están en mi plan.
    </p>
    <p>
      Para esto desde el 1C2025 FIUBA Reviews actualiza sus ofertas gracias a la colaboración de los
      alumnos de las diferentes carreras de la facultad que envían una copia de las ofertas de sus
      carreras para poder generar los listados correctos.
    </p>
