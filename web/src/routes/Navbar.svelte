...
<header
  class="fixed top-0 left-0 z-100 h-[calc(56px+env(safe-area-inset-top))] w-full border-b border-layout-border bg-background/92 px-4 pt-[env(safe-area-inset-top)]"
>
