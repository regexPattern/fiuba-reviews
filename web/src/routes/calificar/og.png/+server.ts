...
import StaticOGImgCalificar from "$lib/assets/open-graph/StaticOGImgCalificar.svelte";
...
export const GET: RequestHandler = async () => {
  ...
  return new ImageResponse(StaticOGImgCalificar, { width: 1200, height: 630, fonts });
};
