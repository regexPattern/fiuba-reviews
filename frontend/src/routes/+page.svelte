<script lang="ts">
	...
	import TarjetaComentarioEjemplo from "$lib/components/TarjetaComentarioEjemplo.svelte";
...
<main class="container mx-auto p-4">
	<section>
		...
		<div class="mt-4 max-w-[750px] space-y-3 text-lg text-slate-500 dark:text-slate-300 sm:text-xl">
			...
			<p>
				Este proyecto está inspirado en el <a
					href="https://dollyfiuba.com"
					target="_blank"
					class="inline-link">Dolly</a
				> original y utiliza los mismos datos para cargar los comentarios históricos guardados a lo largo
				de los años.
			</p>
		</div>
