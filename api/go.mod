...
replace github.com/regexPattern/fiuba-reviews/scraper_siu => ../scraper_siu

require (
	github.com/aws/aws-sdk-go-v2 v1.36.0
	github.com/aws/aws-sdk-go-v2/config v1.29.5
	github.com/aws/aws-sdk-go-v2/service/s3 v1.75.3
	github.com/regexPattern/fiuba-reviews/scraper_siu v0.0.0-00010101000000-000000000000
